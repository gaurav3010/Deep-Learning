...
X_back, Y_back = read_all_my_train('C:/Users/hp/Desktop/GitHub projects/Deep Learning IIT/Deep Learning/Contest-3/train/background') 
Y_back = Y_back[:,np.newaxis]


X_en, Y_en = read_all_my_train('C:/Users/hp/Desktop/GitHub projects/Deep Learning IIT/Deep Learning/Contest-3/train/en')
Y_en = Y_en[:,np.newaxis]

X_back_en = np.concatenate((X_back, X_en))
Y_back_en = np.concatenate((Y_back, Y_en))

X_hi, Y_hi = read_all_my_train('C:/Users/hp/Desktop/GitHub projects/Deep Learning IIT/Deep Learning/Contest-3/train/hi')
Y_hi = Y_hi[:,np.newaxis]

X_back_en_hi = np.concatenate((X_back_en, X_hi))
Y_back_en_hi = np.concatenate((Y_back_en, Y_hi))

X_ta, Y_ta = read_all_my_train('C:/Users/hp/Desktop/GitHub projects/Deep Learning IIT/Deep Learning/Contest-3/train/ta')
...
g_X = read_all_my_test('C:/Users/hp/Desktop/GitHub projects/Deep Learning IIT/Deep Learning/Contest-3/test')
